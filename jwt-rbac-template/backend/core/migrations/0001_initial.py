# Generated by Django 5.1.7 on 2026-02-18 09:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('user', 'User')], default='user', help_text='User role for access control', max_length=20)),
